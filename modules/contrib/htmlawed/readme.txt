...
For full description, Help, suggestions, etc., visit the project page:
...
Note that even though the default htmLawed config. sets the 'safe' parameter to
1, HTML security vulnerabilities may arise depending on how other htmLawed
