...
class ApiSettingsForm extends ConfigFormBase {
  ...
  const FORM_ID = 'salesforce_integration';
  ...
  protected function getEditableConfigNames() {
    return [
      'salesforce_integration.salesforce_integration_settings',
    ];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('salesforce_integration.salesforce_integration_settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('salesforce_integration.salesforce_integration_settings')
