 ...
 *
 * @WebformHandler(
 *   id = "web_to_case_webform_handler",
 *   label = @Translation("Web-to-Case Integration Webform Handler"),
 *   category = @Translation("Custom"),
 *   description = @Translation("Handles submissions for Web-to-Case integration"),
 *   cardinality = \Drupal\webform\Plugin\WebformHandlerInterface::CARDINALITY_SINGLE,
 *   results = \Drupal\webform\Plugin\WebformHandlerInterface::RESULTS_PROCESSED,
 *   submission = \Drupal\webform\Plugin\WebformHandlerInterface::SUBMISSION_OPTIONAL,
 * )
 */
class WebToCaseWebformHandler extends RemotePostWebformHandler {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state, WebformSubmissionInterface $webform_submission) {
    // Calling server-side validation.
    ...
    try {
      ...
      if ($statusCode == 200) {
        \Drupal::logger('salesforce_api')->info("SUCCESS! Submitted Data to API: " . json_encode($data));
