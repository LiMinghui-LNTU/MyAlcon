...
// 检查 settings.php 中的缓存配置
#$settings['cache']['default'] = 'cache.backend.database'; // 临时切换为数据库缓存
...
// 使用内存缓存（临时方案）
#$settings['cache']['default'] = 'cache.backend.memory';
$settings['container_service_definitions'] = function (ContainerBuilder $container) {
	  // 调整 cache.backend.memory 的依赖
	  $container->getDefinition('cache.backend.memory')->clearTags();
   };
 ...
 * @endcode
 */
$settings['hash_salt'] = '0BKgI3LDVCu5kd5FvZqE2mN-ACvfP6bItTEEtEF35ECypmjszYyoXlnrvTWRTRFycHKwC5TDrg';
...
$databases['default']['default'] = array (
  'database' => 'db_myalcon_drupal',
  'username' => 'db_myalcon_drupal',
  'password' => 'pQZXP3CgH0R8oWXR',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '3306',
...
#$settings['config_sync_directory'] = 'sites/default/files/config_5v4-xvTSosv1MUj6JQqDmby1T5orvBy9UaSRMxlM-GOkEacMUiaNxVRa-C6l524gy7M6ZkaiCQ/sync';
